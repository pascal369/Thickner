...
class MyWebEnginePage(QtWebEngineWidgets.QWebEnginePage):
  def certificateError(self, error):
    ...
    msgBox.setWindowTitle("SteelStructure")
    msgBox.setText("An invalid certificate was encountered while loading SteelStructure. Proceed anyway?")
...
class Dialog(QtWidgets.QDialog):
  def __init__(self):
    ...
    # Setup the widget.
    self.setObjectName("SteelStructure_Dialog")
    self.setWindowTitle("SteelStructure")
    '''
    # Grab the browser.
    import browser
    ...
    channel.registerObject("SteelStructureNativeAPI", self.threeDNativeAPI)
