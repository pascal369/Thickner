...
class S08:
    ...
    def execute(self, obj):
        ...
        if ShapedSteel=='Angle':
            ...
            angle(self)
            c01=c00
            c01.Placement=App.Placement(App.Vector(L1-t,0,H),App.Rotation(App.Vector(0,1,0),-90))
            #カッターL
            vx=-1
            vz=-1
            L=A
            ...
            cutter(self)
            c02=c00
            c02.Placement=App.Placement(App.Vector(w0,0,H),App.Rotation(App.Vector(0,0,1),0))
            c01=c01.cut(c02)
            c1=c1.fuse(c01)
            ...
            if Type=='s09':
                ...
                angle(self)
                c01=c00
                c01.Placement=App.Placement(App.Vector(L1,0,H-H1),App.Rotation(App.Vector(0,1,0),-90))
                vx=1
                vy=1
                L=A
                angle(self)
                c03=c00
                c03.Placement=App.Placement(App.Vector(0,0,H-H1-A),App.Rotation(App.Vector(0,0,1),0))
                c01=c01.cut(c02)
                c01=c01.cut(c03)
                c1=c1.fuse(c01)
            obj.Shape=c1    
            ...
            if BasePlate==True:
                angle_bp(self)
                c01=c00
                c01.Placement=App.Placement(App.Vector(-10,-(y-A)/2,0),App.Rotation(App.Vector(0,0,1),0))
                c1=c1.fuse(c01)
    
                angle_bp(self)
                c01=c00
                c01.Placement=App.Placement(App.Vector(L1,-(y-A)/2,H-(A+10)),App.Rotation(App.Vector(0,1,0),-90))
                c1=c1.fuse(c01)
            ...
            if Type=='s09':
                if BasePlate==True:
                    angle_bp(self)
                    c01=c00
                    c01.Placement=App.Placement(App.Vector(L1,-(y-A)/2,H-H1-(A+10)),App.Rotation(App.Vector(0,1,0),-90))
                    c1=c1.fuse(c01)

            c1=c1.removeSplitter()
            obj.Shape=c1
        elif ShapedSteel=='Channel':
            ...
            channel2(self)
            c01=c00
            c01.Placement=App.Placement(App.Vector(L1-t0,0,H),App.Rotation(App.Vector(0,1,0),-90))
            c1=c1.fuse(c01)
            ...
            if Type=='s09':
                ...
                channel2(self)
                c01=c00
                c01.Placement=App.Placement(App.Vector(L1-t0,0,H-H1),App.Rotation(App.Vector(0,1,0),-90))
                c1=c1.fuse(c01)
            ...
            if BasePlate==True:
                channel_bp(self)
                c01=c00
                c01.Placement=App.Placement(App.Vector(-(x-H0)/2,-(y-B)/2,0),App.Rotation(App.Vector(0,0,1),0))
                c1=c1.fuse(c01)
                channel_bp(self)
                c01=c00
                c01.Placement=App.Placement(App.Vector(L1,-(y-B)/2,H-(H0+x)/2),App.Rotation(App.Vector(0,1,0),-90))
                c1=c1.fuse(c01)
            ...
            if Type=='s09':
                if BasePlate==True:
                    channel_bp(self)
                    c01=c00
                    c01.Placement=App.Placement(App.Vector(L1,-(y-B)/2,H-H1-(H0+x)/2),App.Rotation(App.Vector(0,1,0),-90))
                    c1=c1.fuse(c01)
            #リブ
            #L上
            rib_channel(self)
            c01=c00
            c01.Placement=App.Placement(App.Vector(0,0,H-t1),App.Rotation(App.Vector(0,0,1),0))
            c1=c1.fuse(c01)
            rib_channel(self)
            c01=c00
            c01.Placement=App.Placement(App.Vector(0,0,H-H0),App.Rotation(App.Vector(0,0,1),0))
            c1=c1.fuse(c01)
            ...
            if Type=='s09':
                ...
                rib_channel(self)
                c01=c00
                c01.Placement=App.Placement(App.Vector(0,0,H-t1-H1),App.Rotation(App.Vector(0,0,1),0))
                c1=c1.fuse(c01)
                rib_channel(self)
                c01=c00
                c01.Placement=App.Placement(App.Vector(0,0,H-H0-H1),App.Rotation(App.Vector(0,0,1),0))
                c1=c1.fuse(c01)
        c1=c1.removeSplitter() 
