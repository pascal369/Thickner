    ...
    def execute(self, obj):
        ...
        def hexagon_bolt(self):
            ...
            if flange==True:
                ...
                L3=3*D0
                c1= Part.makeCylinder(D0/2,1.5*stem_length,Base.Vector(-(C+D0+2*t)/2,0,0),Base.Vector(0,0,1),360)#ねじ部 
                c2= Part.makeCylinder(D0/2,1.5*stem_length,Base.Vector((C+D0+2*t)/2,0,0),Base.Vector(0,0,1),360)#ねじ部 
                c02= Part.makeCylinder(D0/2,L3,Base.Vector(-(C+D0+2*t)/2,0,thread_length),Base.Vector(0,0,1),360)#軸部
                c03= Part.makeCylinder(D0/2,L3,Base.Vector((C+D0+2*t)/2,0,thread_length),Base.Vector(0,0,1),360)#軸部
            else:
                L3=stem_length-thread_length
                c1= Part.makeCylinder(D0/2,1.5*stem_length,Base.Vector(-(C+D0+2*t)/2,0,0),Base.Vector(0,0,1),360)#ねじ部 
                c2= Part.makeCylinder(D0/2,1.5*stem_length,Base.Vector((C+D0+2*t)/2,0,0),Base.Vector(0,0,1),360)#ねじ部 
