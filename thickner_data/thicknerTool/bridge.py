...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.pushButton.setGeometry(QtCore.QRect(50, 60, 90, 22))
        #更新
        self.pushButton2 = QtGui.QPushButton('update',Dialog)
        self.pushButton2.setGeometry(QtCore.QRect(140, 60, 60, 22))
        #importData
        self.pushButton3 = QtGui.QPushButton('Import Data',Dialog)
        self.pushButton3.setGeometry(QtCore.QRect(50, 85, 150, 22))
    ...
    def read_data(self):
         ...
         if selection:
             ...
             if selected_object.TypeId == "App::Part":
                 ...
                 self.le_hw.setText(spreadsheet.getContents('hight'))
                 App.ActiveDocument.recompute()
                          
    def update(self):
            #return
            dia=self.comboBox_D.currentText()
            hight=self.le_hw.text()
