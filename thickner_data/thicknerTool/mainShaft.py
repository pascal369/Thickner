...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_rp.setStyleSheet("color: gray;")
        ...
        self.label_rbc.setStyleSheet("color: gray;")
        ...
        self.label_sp.setStyleSheet("color: gray;")
        ...
        self.label_skb.setStyleSheet("color: gray;")
        ...
        self.label_rts.setStyleSheet("color: gray;")
